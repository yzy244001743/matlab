...
% ÆæÒì²âÊÔ
Theta=[39.0000  0   0.0000  11.5,  0.0000  19.7];% j1¡¢j4¡¢j6¹²ÖáÆæÒì + ±ß½çÆæÒì -- rank(J0)=4
% Theta=[7.0000  0   0.0000  0,  0.0000  0];% j1¡¢j4¡¢j6¹²ÖáÆæÒì + ±ß½çÆæÒì -- rank(J0)=3
% Theta=[20.0000  0   0.0000  10  88.0000  20.0000];% j1¡¢j4¹²ÖáÆæÒì  + ±ß½çÆæÒì
% Theta = [2.3, 120.3, -15.5, 11.5, 0, 19.7];% j4¡¢j6¹²ÖáÆæÒì
% Theta = [2.3, 120.3, 0, 11.5, 13.8, 19.7];% ±ß½çÆæÒì
%
% Íó²¿ÇòÃæÖÐµãÎ»ÓÚJ1ÖáÏßÉÏÆæÒì
j2 = 30*pi/180;%>0
